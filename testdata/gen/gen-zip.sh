...
# --- nested-enc-rar.zip: zip containing a content-encrypted rar -------------
# Depends on testdata/rar/rar5-enc.rar (generated by gen-rar.sh, needs WinRAR).
mkdir -p "$TMP/build5"
cp "$OUT/../rar/rar5-enc.rar" "$TMP/build5/rar5-enc.rar"
touch_epoch "$TMP/build5"
(cd "$TMP/build5" && zip -X -q "$OUT/nested-enc-rar.zip" rar5-enc.rar)
